<footer class="footer">
            ...
            <div class="footer-content">
                ...
                <div class="footer-links">
                    ...
                    <ul>
                        ...
                        <li><a href="<?php echo e(url('/seller')); ?>">Become a Seller</a></li>
    ...
    <div class="footer-bottom">
        <p>&copy; <?php echo e(date('Y')); ?> MindanaoMarket. All rights reserved. | <a href="<?php echo e(url('/terms')); ?>">Terms & Conditions</a> | <a href="<?php echo e(url('/privacy-policy')); ?>">Privacy Policy</a></p>
    </div>
</footer>
<?php /**PATH C:\xampp\htdocs\example-app\resources\views/partials/footer.blade.php ENDPATH**/ ?>